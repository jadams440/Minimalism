    ...
    var Gamepad = {
        ...
        update: function() {
            ...
            if (this.pad1State) {
                ...
                this.clearPad1();   // Make this a disconnect() function that doesnt run each update
            }
            this.updateIn();
        },
        ...
        updateGamepad: function () {
            ...
            // The left stick maps to the d-pad and takes precident
        ...
        clearPad1: function() {
            this.Pad1.isDown.A = 0;
            this.Pad1.isDown.B = 0;
            this.Pad1.isDown.X = 0;
            this.Pad1.isDown.Y = 0;
            this.Pad1.isDown.LB = 0;
            this.Pad1.isDown.LT = 0;
            this.Pad1.isDown.RB = 0;
            this.Pad1.isDown.RT = 0;
            this.Pad1.isDown.Start = 0;
            this.Pad1.isDown.Back = 0;
            this.Pad1.isDown.DU = 0;
            this.Pad1.isDown.DD = 0;
            this.Pad1.isDown.DL = 0;
            this.Pad1.isDown.DR = 0;
            this.Pad1.leftStick.x = 0.0;
            this.Pad1.leftStick.y = 0.0;
            this.Pad1.rightStick.x = 0.0;
            this.Pad1.rightStick.y = 0.0;
        },

        onKeyDown: function(evt) {
            if (this.keyboardEnabled) {
                // Stop the page scrolling when using up and down arrows
